...
> **Credential System**: Arteamis uses encrypted credentials stored in the database. Each credential connects to a provider and allows you to discover, register, and test models.

---

## Overview

Arteamis manages AI provider access through a **credential-based system**:
...
3. The models are now available throughout Arteamis
