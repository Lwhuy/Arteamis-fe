...
This document outlines coding standards and best practices for Arteamis contributions. All code should follow these guidelines to ensure consistency, readability, and maintainability.
...
managing research notebooks within the Arteamis system.
"""
```
...
class Notebook(BaseModel):
    ...
    Notebooks are the primary organizational unit in Arteamis, allowing
