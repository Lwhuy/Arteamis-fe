...
Configuration is how you customize Arteamis for your specific setup. This section covers what you need to know.
...
You will only use .env if you are running Arteamis locally.
...
```
1. Open Arteamis in your browser
