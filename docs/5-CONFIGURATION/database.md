...
Arteamis uses SurrealDB for its database needs. 

---

## Default Configuration

Arteamis should work out of the box with SurrealDB as long as the environment variables are correctly setup. 


### DB running in the same docker compose as Arteamis (recommended)
...
### DB running in the host machine and Arteamis running in Docker
...
### Arteamis and Surreal are running on the same machine
