...
> - **[docker-compose-speaches.yml](../../examples/docker-compose-speaches.yml)** - Speaches + Arteamis
...
```yaml
# In your Arteamis docker-compose.yml
environment:
...
### Arteamis in Docker (macOS/Windows)

**STT Base URL:** `http://host.docker.internal:8969/v1`

### Arteamis in Docker (Linux)
...
# From inside Arteamis container
