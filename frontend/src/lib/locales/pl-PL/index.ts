export const plPL = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Nie udało się nawiązać połączenia z serwerem API Arteamis",
  ...
  connections: {
    title: "Połączenia",
    subtitle: "Połącz narzędzia, w których znajduje się wiedza Twojej firmy.",
    connected: "Połączone źródła",
    ...
    importPartial: "{ok} zaimportowano, {fail} nie powiodło się.",
    disconnected: "Rozłączono.",
    connectedToast: "Połączono pomyślnie.",
  },
  chat: {
    sessions: "Sesje",
  ...
  controlPlane: {
    ...
    lineage: {
      ...
      createDecision: "Utwórz decyzję na podstawie tego przekonania",
    },
  ...
  settings: {
    ...
    filesHelp: "Po przesłaniu i przetworzeniu plików nie są one już potrzebne. Większość użytkowników powinna pozwolić Arteamis na automatyczne usuwanie przesłanych plików z folderu przesyłania.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Dostępna jest nowa wersja Arteamis.",
    upToDate: "Aktualna",
    unknown: "Nieznana",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Skonfiguruj, których modeli używać do różnych celów w Arteamis",
    missingRequiredModels: "Brakuje wymaganych modeli: {models}. Bez nich Arteamis może nie działać poprawnie.",
  ...
  apiKeys: {
    ...
    description: "Przechowuj klucze API bezpiecznie w bazie danych, aby włączyć dostawców AI w Arteamis.",
  ...
  governance: {
    ...
    toastDecisionCreated: "Decyzja utworzona",
