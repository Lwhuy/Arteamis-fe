export const zhTW = {
  ...
  apiErrors: {
    ...
    invitationExpired: "此邀請已過期或被撤銷",
    emailMismatch: "此邀請寄送至其他電子郵件",
  },
  connectionErrors: {
    apiTitle: "無法連線到 API 伺服器",
    apiDesc: "無法存取 Arteamis API 伺服器",
    dbTitle: "資料庫連線失敗",
  ...
  invitations: {
    ...
    roleAdmin: "管理員",
    roleMember: "成員",
    projectScopeToggle: "邀請加入特定專案",
    projectLabel: "專案",
    sendInvite: "傳送邀請",
    emailedSuccess: "邀請已透過電子郵件寄出",
    copyLinkTitle: "分享此邀請連結",
    copyLink: "複製連結",
    copied: "已複製",
    revoke: "撤銷",
    revokeConfirm: "撤銷此邀請？連結將失效。",
    revokeSuccess: "邀請已撤銷",
    acceptTitle: "您已被邀請",
    acceptButton: "接受邀請",
    acceptSuccess: "已接受邀請",
    emailMismatch: "此邀請寄送至其他電子郵件。",
    expiredTitle: "邀請已過期或被撤銷",
    expiredBody: "此邀請已失效。請聯絡管理員重新寄送。",
    createAccountCta: "建立帳戶",
    signInCta: "登入",
  },
  notebooks: {
    title: "筆記本",
  ...
  connections: {
    ...
    importPartial: "{ok} 個已匯入，{fail} 個失敗。",
    disconnected: "已中斷連接。",
    connectedToast: "連接成功。",
  },
  chat: {
  ...
  advanced: {
    ...
    updateAvailableDesc: "Arteamis 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "設定用於 Arteamis 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有這些模型，Arteamis 可能無法正常運行。",
  ...
  apiKeys: {
    ...
    description: "將 API 金鑰安全地儲存在資料庫中，以在 Arteamis 中啟用 AI 服務商。",
  ...
  governance: {
    ...
    toastDecisionCreated: "決策已建立",
    toastRuleCreated: "規則已建立",
    toastWorkPackageCreated: "工作包已建立",
    toastWorkPackageStatusUpdated: "工作包狀態已更新",
    toastTraceRecorded: "追蹤已記錄",
    toastLearningProposed: "學習提案已建立",
  },
  setupBanner: {
    encryptionRequired: "未設定加密金鑰",
