...
export const deDE = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Der Arteamis API-Server konnte nicht erreicht werden",
    ...
    docLink: "Arteamis-Dokumentation",
  ...
  connections: {
    title: "Verbindungen",
    subtitle: "Verbinde die Tools, in denen das Wissen deines Unternehmens liegt.",
    connected: "Verbundene Quellen",
    ...
    importPartial: "{ok} importiert, {fail} fehlgeschlagen.",
    disconnected: "Getrennt.",
    connectedToast: "Erfolgreich verbunden.",
  },
  chat: {
    sessions: "Sitzungen",
  ...
  settings: {
    ...
    filesHelp: "Nachdem deine Dateien hochgeladen und verarbeitet wurden, werden sie nicht mehr benötigt. Die meisten Nutzer sollten Arteamis erlauben, hochgeladene Dateien automatisch aus dem Upload-Ordner zu löschen.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Eine neue Version von Arteamis ist verfügbar.",
    upToDate: "Aktuell",
    unknown: "Unbekannt",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Konfiguriere, welche Modelle Arteamis für verschiedene Zwecke verwendet",
    missingRequiredModels: "Erforderliche Modelle fehlen: {models}. Arteamis funktioniert ohne diese möglicherweise nicht korrekt.",
  ...
  apiKeys: {
    ...
    description: "Speichere API-Schlüssel sicher in der Datenbank, um KI-Anbieter in Arteamis zu aktivieren.",
  ...
  governance: {
    ...
    toastTraceRecorded: "Trace aufgezeichnet",
    toastLearningProposed: "Lernvorschlag erstellt",
  },
  setupBanner: {
    encryptionRequired: "Verschlüsselungsschlüssel nicht konfiguriert",
