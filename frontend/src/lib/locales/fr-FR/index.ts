export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de Arteamis est injoignable",
    ...
    docLink: "Documentation de Arteamis",
  ...
  connections: {
    title: "Connexions",
    subtitle: "Connectez les outils où se trouvent les connaissances de votre entreprise.",
    connected: "Sources connectées",
    ...
    importPartial: "{ok} importé(s), {fail} échoué(s).",
    disconnected: "Déconnecté.",
    connectedToast: "Connecté avec succès.",
  },
  chat: {
    sessions: "Sessions",
  ...
  controlPlane: {
    ...
    lineage: {
      ...
      createDecision: "Créer une décision à partir de cette croyance",
    },
    ...
    brain: {
      ...
      decisionsEmpty: "Aucune décision pour le moment.",
      rulesTitle: "Règles",
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser Arteamis à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de Arteamis est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'Arteamis",
    missingRequiredModels: "Modèles requis manquants : {models}. Arteamis pourrait ne pas fonctionner correctement sans eux.",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans Arteamis.",
  ...
  intelligence: {
    comingSoon: {
      ...
      description: "Intelligence est en cours de construction. Revenez bientôt.",
    },
    title: "Intelligence",
