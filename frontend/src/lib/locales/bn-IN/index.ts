export const bnIN = {
  ...
  apiErrors: {
    ...
    invitationExpired: "এই আমন্ত্রণের মেয়াদ শেষ হয়েছে বা প্রত্যাহার করা হয়েছে",
    emailMismatch: "এই আমন্ত্রণটি অন্য একটি ইমেলে পাঠানো হয়েছিল",
  },
  connectionErrors: {
    apiTitle: "API সার্ভারে সংযোগ করতে অক্ষম",
    apiDesc: "Arteamis API সার্ভারে পৌঁছানো যায়নি",
  ...
  invitations: {
    title: "একজন সদস্যকে আমন্ত্রণ জানান",
    pending: "অপেক্ষমাণ আমন্ত্রণ",
    members: "সদস্যরা",
    ...
    roleAdmin: "অ্যাডমিন",
    roleMember: "সদস্য",
    projectScopeToggle: "একটি নির্দিষ্ট প্রকল্পে আমন্ত্রণ",
    projectLabel: "প্রকল্প",
    sendInvite: "আমন্ত্রণ পাঠান",
    emailedSuccess: "আমন্ত্রণ ইমেল করা হয়েছে",
    copyLinkTitle: "এই আমন্ত্রণ লিঙ্কটি শেয়ার করুন",
    copyLink: "লিঙ্ক কপি করুন",
    copied: "কপি করা হয়েছে",
    revoke: "প্রত্যাহার",
    revokeConfirm: "এই আমন্ত্রণটি প্রত্যাহার করবেন? লিঙ্কটি আর কাজ করবে না।",
    revokeSuccess: "আমন্ত্রণ প্রত্যাহার করা হয়েছে",
    acceptTitle: "আপনাকে আমন্ত্রণ জানানো হয়েছে",
    acceptButton: "আমন্ত্রণ গ্রহণ করুন",
    acceptSuccess: "আমন্ত্রণ গৃহীত হয়েছে",
    emailMismatch: "এই আমন্ত্রণটি অন্য একটি ইমেলে পাঠানো হয়েছিল।",
    expiredTitle: "আমন্ত্রণ মেয়াদোত্তীর্ণ বা প্রত্যাহৃত",
    expiredBody: "এই আমন্ত্রণটি আর বৈধ নয়। একজন অ্যাডমিনকে নতুন একটি পাঠাতে বলুন।",
  ...
  connections: {
    title: "সংযোগসমূহ",
    subtitle: "আপনার কোম্পানির জ্ঞান যেখানে থাকে সেই টুলগুলো সংযুক্ত করুন।",
    connected: "সংযুক্ত উৎসসমূহ",
    ...
    import: "ইম্পোর্ট",
    selectNotebook: "নোটবুকে যোগ করুন (আবশ্যক)",
    searchItems: "অনুসন্ধান করুন…",
    noItems: "ইম্পোর্ট করার মতো কিছু নেই।",
    importStarted: "{count}টি আইটেম ইম্পোর্ট করা হচ্ছে — ব্যাকগ্রাউন্ডে প্রক্রিয়াকরণ চলছে।",
    importPartial: "{ok}টি ইম্পোর্ট হয়েছে, {fail}টি ব্যর্থ হয়েছে।",
    disconnected: "সংযোগ বিচ্ছিন্ন হয়েছে।",
    connectedToast: "সফলভাবে সংযুক্ত হয়েছে।",
  },
  chat: {
    sessions: "সেশনগুলি",
  ...
  settings: {
    ...
    filesHelp: "একবার আপনার ফাইল আপলোড এবং প্রক্রিয়া হওয়ার পর, সেগুলি আর প্রয়োজন নেই। বেশিরভাগ ব্যবহারকারী Arteamis কে আপলোড ফোল্ডার থেকে আপলোড করা ফাইল স্বয়ংক্রিয়ভাবে মুছে ফেলার অনুমতি দিতে পারেন।",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Arteamis এর একটি নতুন সংস্করণ উপলব্ধ।",
    upToDate: "আপ টু ডেট",
    unknown: "অজানা",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Arteamis জুড়ে বিভিন্ন কাজের জন্য কোন মডেল ব্যবহার করব তা কনফিগার করুন",
    missingRequiredModels: "প্রয়োজনীয় মডেল অনুপস্থিত: {models}। এগুলি ছাড়া Arteamis সঠিকভাবে কাজ নাও করতে পারে।",
  ...
  apiKeys: {
    ...
    description: "Arteamis এ AI প্রোভাইডার সক্ষম করতে ডেটাবেসে নিরাপদভাবে API কী সংরক্ষণ করুন।",
