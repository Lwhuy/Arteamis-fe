export const jaJP = {
  ...
  apiErrors: {
    ...
    invitationExpired: "この招待は期限切れまたは取り消されました",
    emailMismatch: "この招待は別のメールアドレス宛です",
  },
  connectionErrors: {
    apiTitle: "APIサーバーに接続できません",
    apiDesc: "Arteamis APIサーバーに到達できませんでした",
  ...
  invitations: {
    ...
    roleAdmin: "管理者",
    roleMember: "メンバー",
    projectScopeToggle: "特定のプロジェクトに招待",
    projectLabel: "プロジェクト",
    sendInvite: "招待を送信",
    emailedSuccess: "招待メールを送信しました",
    copyLinkTitle: "この招待リンクを共有",
    copyLink: "リンクをコピー",
    copied: "コピーしました",
    revoke: "取り消し",
    revokeConfirm: "この招待を取り消しますか？リンクは無効になります。",
    revokeSuccess: "招待を取り消しました",
    acceptTitle: "招待されています",
    acceptButton: "招待を承認",
    acceptSuccess: "招待を承認しました",
    emailMismatch: "この招待は別のメールアドレス宛です。",
    expiredTitle: "招待の有効期限切れまたは取り消し済み",
    expiredBody: "この招待は無効です。管理者に再送を依頼してください。",
  ...
  connections: {
    title: "連携",
    subtitle: "会社のナレッジが存在するツールと連携します。",
    connected: "接続済みのソース",
    addMore: "追加する",
    comingSoon: "近日公開",
    connect: "接続",
    ...
    importPartial: "{ok} 件成功、{fail} 件失敗しました。",
    disconnected: "切断しました。",
    connectedToast: "接続に成功しました。",
  },
  chat: {
    sessions: "セッション",
  ...
  settings: {
    ...
    filesHelp: "ファイルがアップロードされて処理されると、ファイル自体は不要になります。ほとんどのユーザーはArteamisがアップロードフォルダから自動的にファイルを削除することを許可すべきです。",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Arteamisの新しいバージョンが利用可能です。",
    upToDate: "最新版です",
    unknown: "不明",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Arteamis全体で異なる目的に使用するモデルを設定",
    missingRequiredModels: "必須モデルがありません: {models}。これらがないとArteamisが正しく機能しない可能性があります。",
  ...
  apiKeys: {
    ...
    description: "APIキーをデータベースに安全に保存し、ArteamisでAIプロバイダーを有効にします。",
