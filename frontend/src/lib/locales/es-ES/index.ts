export const esES = {
  ...
  connectionErrors: {
    ...
    apiDesc: "No se pudo alcanzar el servidor API de Arteamis",
    ...
    docLink: "Documentación de Arteamis",
  ...
  connections: {
    title: "Conexiones",
    subtitle: "Conecta las herramientas donde vive el conocimiento de tu empresa.",
    connected: "Fuentes conectadas",
    addMore: "Añadir más",
    ...
    importPartial: "{ok} importado(s), {fail} fallido(s).",
    disconnected: "Desconectado.",
    connectedToast: "Conectado correctamente.",
  },
  chat: {
    sessions: "Sesiones",
  ...
  settings: {
    ...
    filesHelp: "Una vez que tus archivos se suben y procesan, ya no son necesarios. La mayoría de los usuarios deberían permitir que Arteamis elimine los archivos subidos de la carpeta de carga automáticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Una nueva versión de Arteamis está disponible.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura qué modelos usar para diferentes propósitos en Arteamis",
    missingRequiredModels: "Faltan modelos requeridos: {models}. Arteamis puede no funcionar correctamente sin estos.",
  ...
  apiKeys: {
    ...
    description: "Almacena claves API de forma segura en la base de datos para habilitar proveedores de IA en Arteamis.",
  ...
  intelligence: {
    comingSoon: {
      title: "Próximamente",
      description: "Intelligence está en construcción. Vuelve pronto.",
    },
    title: "Intelligence",
