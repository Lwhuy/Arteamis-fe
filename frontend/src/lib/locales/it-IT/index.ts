export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di Arteamis non è raggiungibile",
    ...
    docLink: "Documentazione Arteamis",
  ...
  connections: {
    title: "Connessioni",
    subtitle: "Collega gli strumenti in cui risiede la conoscenza della tua azienda.",
    connected: "Fonti connesse",
    ...
    importPartial: "{ok} importati, {fail} falliti.",
    disconnected: "Disconnesso.",
    connectedToast: "Connesso con successo.",
  },
  chat: {
    sessions: "Sessioni",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a Arteamis di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di Arteamis.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in Arteamis",
    missingRequiredModels: "Modelli richiesti mancanti: {models}. Arteamis potrebbe non funzionare correttamente senza questi.",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in Arteamis.",
