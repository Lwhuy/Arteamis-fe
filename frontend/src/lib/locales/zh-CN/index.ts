export const zhCN = {
  ...
  apiErrors: {
    ...
    invitationExpired: "此邀请已过期或被撤销",
    emailMismatch: "此邀请发送至其他邮箱",
  },
  connectionErrors: {
    apiTitle: "无法连接到 API 服务器",
    apiDesc: "无法访问 Arteamis API 服务器",
    dbTitle: "数据库连接失败",
  ...
  invitations: {
    ...
    roleAdmin: "管理员",
    roleMember: "成员",
    projectScopeToggle: "邀请加入特定项目",
    projectLabel: "项目",
    sendInvite: "发送邀请",
    emailedSuccess: "邀请已通过邮件发送",
    copyLinkTitle: "分享此邀请链接",
    copyLink: "复制链接",
    copied: "已复制",
    revoke: "撤销",
    revokeConfirm: "撤销此邀请？链接将失效。",
    revokeSuccess: "邀请已撤销",
    acceptTitle: "您已被邀请",
    acceptButton: "接受邀请",
    acceptSuccess: "已接受邀请",
    emailMismatch: "此邀请发送至其他邮箱。",
    expiredTitle: "邀请已过期或被撤销",
    expiredBody: "此邀请已失效。请让管理员重新发送。",
  ...
  connections: {
    ...
    importPartial: "{ok} 个已导入，{fail} 个失败。",
    disconnected: "已断开连接。",
    connectedToast: "连接成功。",
  },
  chat: {
  ...
  models: {
    ...
    defaultAssignmentsDesc: "配置用于 Arteamis 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有这些模型，Arteamis 可能无法正常运行。",
  ...
  apiKeys: {
    ...
    description: "将 API 密钥安全地存储在数据库中，以在 Arteamis 中启用 AI 服务商。",
