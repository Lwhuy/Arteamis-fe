export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The Arteamis API server could not be reached",
    ...
    docLink: "Arteamis Documentation",
  ...
  connections: {
    ...
    import: "Import",
    selectNotebook: "Add to notebook (required)",
    searchItems: "Search…",
    ...
    connectedToast: "Connected successfully.",
  },
  chat: {
    sessions: "Sessions",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Arteamis to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Arteamis is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Arteamis",
    missingRequiredModels: "Missing required models: {models}. Arteamis may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in Arteamis.",
  ...
  intelligence: {
    comingSoon: {
      title: "Coming soon",
      description: "Intelligence is under construction. Check back soon.",
    },
    title: "Intelligence",
