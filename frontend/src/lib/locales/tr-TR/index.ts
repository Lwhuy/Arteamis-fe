export const trTR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Arteamis API sunucusuna ulaşılamadı",
  ...
  connections: {
    title: "Bağlantılar",
    subtitle: "Şirketinizin bilgisinin bulunduğu araçları bağlayın.",
    connected: "Bağlı kaynaklar",
    ...
    importPartial: "{ok} içe aktarıldı, {fail} başarısız oldu.",
    disconnected: "Bağlantı kesildi.",
    connectedToast: "Başarıyla bağlandı.",
  },
  chat: {
    sessions: "Oturumlar",
  ...
  settings: {
    ...
    filesHelp: "Dosyalarınız yüklenip işlendikten sonra artık gerekli değildir. Çoğu kullanıcı Arteamis'un yüklenen dosyaları yükleme klasöründen otomatik olarak silmesine izin vermelidir.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Arteamis'un yeni bir sürümü mevcut.",
    upToDate: "Güncel",
    unknown: "Bilinmiyor",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Arteamis genelinde farklı amaçlar için hangi modellerin kullanılacağını yapılandırın",
    missingRequiredModels: "Eksik gerekli modeller: {models}. Bu modeller olmadan Arteamis düzgün çalışmayabilir.",
  ...
  apiKeys: {
    ...
    description: "Arteamis'ta yapay zeka sağlayıcılarını etkinleştirmek için API anahtarlarını güvenli şekilde veritabanında saklayın.",
