export const ruRU = {
  ...
  apiErrors: {
    ...
    invitationExpired: "Срок действия приглашения истёк или оно отозвано",
    emailMismatch: "Это приглашение отправлено на другой адрес эл. почты",
  },
  connectionErrors: {
    apiTitle: "Не удаётся подключиться к API-серверу",
    apiDesc: "API-сервер Arteamis недоступен",
  ...
  invitations: {
    ...
    roleMember: "Участник",
    projectScopeToggle: "Пригласить в конкретный проект",
    projectLabel: "Проект",
    sendInvite: "Отправить приглашение",
    emailedSuccess: "Приглашение отправлено по эл. почте",
    copyLinkTitle: "Поделитесь этой ссылкой-приглашением",
    copyLink: "Копировать ссылку",
    copied: "Скопировано",
    revoke: "Отозвать",
    revokeConfirm: "Отозвать приглашение? Ссылка перестанет работать.",
    ...
    emailMismatch: "Это приглашение отправлено на другой адрес эл. почты.",
    expiredTitle: "Приглашение истекло или отозвано",
    expiredBody: "Это приглашение больше не действительно. Попросите администратора отправить новое.",
  ...
  projects: {
    ...
    defaultSourceScope: {
      label: "Область источника по умолчанию",
  ...
  connections: {
    title: "Подключения",
    subtitle: "Подключите инструменты, где хранятся знания вашей компании.",
    ...
    importPartial: "{ok} импортировано, {fail} не удалось.",
    disconnected: "Отключено.",
    connectedToast: "Успешно подключено.",
  },
  chat: {
    sessions: "Сессии",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить Arteamis автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия Arteamis.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в Arteamis",
    missingRequiredModels: "Отсутствуют необходимые модели: {models}. Arteamis может работать некорректно без них.",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в Arteamis.",
